...
export const missionControlGeneratedData = {
  "generatedAt": "2026-06-05T00:04:02.447Z",
  "source": "build-time",
  "projectBoard": {
    "syncStatus": "PMO同步正常",
    "activeTasks": [
  ...
  "git": {
    ...
    "latestMasterCommits": [
      "b1054a7 P0S: merge Mission Control data accuracy fix into master",
      "729414e P0S: fix Mission Control data accuracy",
  ...
  "dispatcherQueue": {
    ...
    "generatedAt": "2026-06-05T00:04:02.132Z",
    "summary": {
      "taskCount": 11,
      "pending": 7,
      "blocked": 0,
